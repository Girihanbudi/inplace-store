...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <script src="/shopresource/winkel/js/jquery.min.js"></script>
    <script src="/shopresource/winkel/js/jquery-migrate-3.0.1.min.js"></script>
    <script src="/shopresource/winkel/js/popper.min.js"></script>
    <script src="/shopresource/winkel/js/bootstrap.min.js"></script>
    <script src="/shopresource/winkel/js/jquery.easing.1.3.js"></script>
    <script src="/shopresource/winkel/js/jquery.waypoints.min.js"></script>
    <script src="/shopresource/winkel/js/jquery.stellar.min.js"></script>
    <script src="/shopresource/winkel/js/owl.carousel.min.js"></script>
    <script src="/shopresource/winkel/js/jquery.magnific-popup.min.js"></script>
    <script src="/shopresource/winkel/js/aos.js"></script>
    <script src="/shopresource/winkel/js/jquery.animateNumber.min.js"></script>
    <script src="/shopresource/winkel/js/bootstrap-datepicker.js"></script>
