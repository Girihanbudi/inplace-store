	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 d-flex align-items-stretch">
				<div class="img" style="background-image: url({{url('shopresource/winkel/images/about-1.jpg')}});"></div>
			</div>
		...
		<div class="row">
			<div class="col-md-5 order-md-last d-flex align-items-stretch">
				<div class="img img-2" style="background-image: url({{url('shopresource/winkel/images/about-2.jpg')}});"></div>
			</div>
